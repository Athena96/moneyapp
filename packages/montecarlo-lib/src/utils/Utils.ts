...
export const adjustForFees = (returns: number[], fees: number, inflation: number) => {
 ...
 */
export const getIncomesAndExpenses = (timeline: number, incomeExpList: AnnualExpensesIncome[], startingAge: number, oneTime: Map<number,number>) => {
