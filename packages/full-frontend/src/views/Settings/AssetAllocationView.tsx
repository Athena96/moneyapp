...
//     handleUseGlidePath(event: React.ChangeOneTime<HTMLInputElement>) {
...
//     handleAllocationChange(e: React.ChangeOneTime<HTMLInputElement | HTMLTextAreaElement>, stardOrEnd: string, asset: 'equities' | 'bonds' | 'cash') {
...
export class AssetAllocationView extends React.Component {
    render() {
        return (<></>)
    }
}