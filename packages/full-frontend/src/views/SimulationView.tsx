...
//         if (window.confirm('Are you sure you want to ADD a new Simulation? This will copy all current Recurring/OneTimes/Inputs to a new Simulation branch.')) {
...
//         if (window.confirm('Are you sure you want to DELETE this simulation? It will delete all associated Recurrings/OneTimes/Inputs...')) {
