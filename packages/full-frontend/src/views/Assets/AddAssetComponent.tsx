            ...
            <>
                <Card variant="outlined" style={{ marginTop: '15px', width: '100%' }}>
                    <CardContent>
                        ...
                        <Stack direction='column' spacing={2}>
                            <TextField label="Ticker Code" id="outlined-basic" variant="outlined" name={`ticker-${this.props.asset.id}`} onChange={this.props.handleChange} value={this.props.asset.ticker} />
                            <TextField label="Quantity" id="outlined-basic" variant="outlined" name={`quantity-${this.props.asset.id}`} onChange={this.props.handleChange} value={this.props.asset.quantity} />
                            <Button id={this.props.asset.id} onClick={this.props.handleDeleteAsset} variant="outlined">Delete</Button>
                            <Button id={this.props.asset.id} onClick={this.props.handleSave} variant="contained">Save</Button>
                        </Stack>
            ...
            <>
                <Card variant="outlined" style={{ marginTop: '15px', width: '100%' }}>
                    <CardContent>
                        ...
                        <Stack direction='column' spacing={2}>
                            <TextField label="Asset Name" id="outlined-basic" variant="outlined" name={`ticker-${this.props.asset.id}`} onChange={this.props.handleChange} value={this.props.asset.ticker} />
                            <TextField label="Current Value (in dollars)" id="outlined-basic" variant="outlined" name={`quantity-${this.props.asset.id}`} onChange={this.props.handleChange} value={this.props.asset.quantity} />
                            <Button id={this.props.asset.id} onClick={this.props.handleDeleteAsset} variant="outlined">Delete</Button>
                            <Button id={this.props.asset.id} onClick={this.props.handleSave} variant="contained">Save</Button>
                        </Stack>
