                ...
                <Card variant="outlined" style={{ marginTop: '15px', width: '100%' }}>
                    <CardContent>
                        ...
                        <Stack direction='column' spacing={2}>
                            ...
                            <TextField label="Quantity" id="outlined-basic" variant="outlined" name={`quantity-${this.props.asset.getKey()}`} onChange={this.props.handleChange} value={this.props.asset.quantity} />
                ...
                <Card variant="outlined" style={{ marginTop: '15px', width: '100%' }}>
                    <CardContent>
                        ...
                        <Stack direction='column' spacing={2}>
                            ...
                            <TextField label="Current Value (in dollars)" id="outlined-basic" variant="outlined" name={`quantity-${this.props.asset.getKey()}`} onChange={this.props.handleChange} value={this.props.asset.quantity} />
                            <Button id={this.props.asset.getKey()} onClick={this.props.handleDeleteAsset} variant="outlined">Delete</Button>
                            <Button id={this.props.asset.getKey()} onClick={this.props.handleSave} variant="contained">Save</Button>
                        </Stack>
